...
## Type: QssColor
c.colors.completion.match.fg = '#01FE65'
...
## Type: QtColor
c.colors.downloads.error.bg = 'darkgrey'
...
## Type: QtColor
c.colors.tabs.selected.even.fg = '#5CFF00'
...
## Type: QtColor
c.colors.tabs.selected.odd.fg = '#5CFF00'
...
## Type: QtFont
c.fonts.tabs = '13pt DejaVu Sans Mono'
...
## Type: String
c.hints.border = '1px solid #5CFF00'

## Chars used for hint strings.
## Type: UniqueCharString
c.hints.chars = 'asdfghjklwerui'
...
## Type: Padding
c.statusbar.padding = {'top': 5, 'bottom': 1, 'left': 5, 'right': 5}
...
## Type: FuzzyUrl
c.url.default_page = '~/.qutebrowser/startpage.html'
...
c.url.start_pages = ['~/.qutebrowser/startpage.html']
...
## Type: List of Perc
c.zoom.levels = ['25%', '33%', '50%', '67%', '75%', '90%', '100%', '110%', '115%', '120%', '125%', '130%', '150%', '175%', '200%']
...
config.bind('co', 'tab-next')
config.bind('cxxxxx', 'tab-only')
config.bind('d', 'scroll-page 0 0.5')
...
config.bind('j', 'scroll-page 0 0.03')
config.bind('k', 'scroll-page 0 -0.03')
