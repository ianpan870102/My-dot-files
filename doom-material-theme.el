...
(def-doom-theme doom-material
  ...
  ((bg         '("#263238" nil       nil))
   ...
   (base7      '("#738484" "#767676" "brightblack"))
  ...
  (((lazy-highlight &override) :background base4 :foreground fg :distant-foreground fg :bold bold)
   ...
   ;; ivy
   (ivy-current-match :background base5 :distant-foreground (doom-darken fg 0.2))
   ...
   (region :background base5 :foreground nil :distant-foreground (doom-darken fg 0.3))
   (line-number :inherit 'default :foreground base6)
