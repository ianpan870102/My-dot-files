...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (smooth-scrolling elpy htmlize org-bullets emmet-mode fill-column-indicator rainbow-delimiters flycheck neotree autopair solarized-theme linum-relative auto-complete evil-surround evil-commentary))))
(custom-set-faces
